...
export const projects = [
  ...
  { title: "Multimodal speech emotion recognition", period: "Sep — Dec 2024", institution: "Johns Hopkins University", supervisor: "Najim Dehak", text: "Built a robust multimodal emotion recognition system on MELD, augmenting speech with MUSAN noise and room impulse responses. Compared feature fusion methods combining wav2vec 2.0 acoustic representations with ASR and BERT text features.", tags: ["wav2vec 2.0", "ASR + BERT", "Multimodal fusion"], result: "58.9% five-class accuracy" },
