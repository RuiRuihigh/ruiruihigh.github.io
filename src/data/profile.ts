...
export const projects = [
  { title: "Discrete-token speech language modeling", period: "Jun 2026 — Present", institution: "Carnegie Mellon University", supervisor: "Shinji Watanabe", text: "Exploring alternative speech representations and tokenization strategies for discrete-token speech language models, with a focus on improving modeling quality and robustness.", tags: ["Speech language models", "Discrete speech tokens", "Speech representation"], result: "Improving discrete speech representations" },
  { title: "Multi-speaker speech synthesis", period: "Jun — Jul 2026", institution: "Carnegie Mellon University", supervisor: "Shinji Watanabe", text: "Building multi-speaker TTS on DailyTalk with speaker-conditioned VITS. Contributed a training recipe to ESPnet and released a model through the ESPnet Hugging Face repository.", tags: ["VITS", "ESPnet", "Text-to-speech"], result: "3.79 UTMOS", url: "https://github.com/RuiRuihigh/espnet/tree/add-dailytalk-tts-recipe", linkLabel: "ESPnet fork" },
  { title: "LLM-based speech recognition", period: "Sep — Dec 2025", institution: "Johns Hopkins University", supervisor: "Najim Dehak", text: "Built an end-to-end speech recognition system combining an audio encoder with an LLM through cross-modal representation alignment. Used staged training with a frozen encoder, Q-Former alignment, and LoRA fine-tuning to preserve learned representations and improve audio-text fusion.", tags: ["Audio encoder", "Q-Former", "LoRA"], result: "2.9% WER on LibriSpeech" },
  { title: "Multimodal speech emotion recognition", period: "Sep — Dec 2024", institution: "Johns Hopkins University", supervisor: "Najim Dehak", text: "Built a robust multimodal emotion recognition system on MELD, augmenting speech with MUSAN noise and room impulse responses. Compared feature fusion methods combining wav2vec 2.0 acoustic representations with ASR and BERT text features.", tags: ["wav2vec 2.0", "ASR + BERT", "Multimodal fusion"], result: "58.9% five-class accuracy", url: "/files/mlsp-final-presentation.pptx", linkLabel: "Presentation" },
  { title: "Interactive singing voice conversion", period: "May — Sep 2023", institution: "CUHK-Shenzhen", supervisor: "Zhizheng Wu", text: "Adapted a diffusion-based singing voice conversion model and built an interactive D3.js interface for exploring intermediate mel-spectrograms and synthesized audio.", tags: ["Diffusion", "PyTorch", "D3.js"], result: "From diffusion steps to sound", url: "/demos/singing-voice-conversion/", linkLabel: "Watch demo" },
];
