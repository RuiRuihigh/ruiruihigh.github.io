...
export const projects = [
  { title: "Multi-speaker speech synthesis", period: "Jun 2026 — Present", institution: "Carnegie Mellon University", supervisor: "Shinji Watanabe", text: "Building multi-speaker TTS on DailyTalk with speaker-conditioned VITS. Contributed a training recipe to ESPnet and released a model through the ESPnet Hugging Face repository.", tags: ["VITS", "ESPnet", "Text-to-speech"], result: "3.79 UTMOS", url: "https://github.com/RuiRuihigh/espnet", linkLabel: "ESPnet fork" },
  { title: "Emotion-aware spoken dialogue", period: "Feb — Jul 2025", institution: "Johns Hopkins University", supervisor: "Najim Dehak & Jesús Villalba", text: "Constructed a 165-hour synthetic dialogue resource with expressive speech, emotion-rich summaries, and utterance-level paralinguistic labels. Evaluated audio-language models for summarization and emotion understanding.", tags: ["Audio-LLMs", "Dataset construction", "Emotion"], result: "165 hours of speech", url: "https://arxiv.org/abs/2512.14687", linkLabel: "Read the paper" },
